...
class Profile_Edit_Develop extends StatefulWidget {
  final String text;
  final bool state;
  const Profile_Edit_Develop(this.text, this.state);
      ...
      children: [
            ...
            child: GestureDetector(
              onTap: () async {
                await showModalBottomSheet(
                  ...
                  (value) => setState(
                    () {
                      context.read<User_Data>().Develop_Delete(widget.text);
                      context.read<User_Data>().Develop_Save(value);
                      develop_text = value;
                    },
                  ),
                );
        ...
        widget.state
            ? GestureDetector(
                onTap: () {
                  setState(() {
                    context.read<User_Data>().Develop_Delete(develop_text);
                  });
                },
                child: Container(
