...
class MyPage_Applicant_Select extends StatefulWidget {
  const MyPage_Applicant_Select();

  @override
  State<MyPage_Applicant_Select> createState() =>
      _MyPage_Applicant_SelectState();
}

class _MyPage_Applicant_SelectState extends State<MyPage_Applicant_Select> {
