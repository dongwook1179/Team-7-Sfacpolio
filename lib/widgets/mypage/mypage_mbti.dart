...
class MyPage_Applicant_MBTI extends StatefulWidget {
  const MyPage_Applicant_MBTI();

  @override
  State<MyPage_Applicant_MBTI> createState() => _MyPage_Applicant_MBTIState();
}

class _MyPage_Applicant_MBTIState extends State<MyPage_Applicant_MBTI> {
