  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: Container(
        ...
        decoration:
            BoxDecoration(shape: BoxShape.circle, color: Color(0xFF196AFF)),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          if (index < CommuityData.length) {
            var data = CommuityData[CommuityData.keys.toList()[index]];
            return Container(
              color: Color(0xFFF8f8F9),
              child: Column(
                children: [
                  MyCommunity_Slot_Build(data)
                  // Column(
                  //   children: [
                  //     Container(
                  //       width: 360,
