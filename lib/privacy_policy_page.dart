        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: ShapeDecoration(
                  shape: RoundedRectangleBorder(
                    side: BorderSide(width: 1, color: Color(0xFF4C4C4C)),
                  ),
                ),
                  ...
                  child: Text.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: '스팩로그는 수집한 개인정보를 다음과 같은 목적으로 이용합니다.\n',
                          style: TextStyle(
                            color: Color(0xFF020202),
                            fontSize: 12,
                            fontFamily: 'Pretendard',
              ...
              Container(
                padding: EdgeInsets.only(left: 15, top: 20, bottom: 14),
                child: Text(
                  '서비스 이용약관',
                  style: TextStyle(
                    color: CupertinoColors.black,
